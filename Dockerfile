...
#
# LES POIDS SONT DANS L'IMAGE — 44,4 Go pour cinq fichiers.
#
# CETTE IMAGE NE SE CONSTRUIT PLUS CHEZ LE LOUEUR (02/09). Son constructeur coupe à
# trente minutes, et notre message d'erreur figure mot pour mot dans sa page de
# limitations, avec la seule issue qu'il propose : construire ailleurs et pousser
# sur un registre. C'est ce que RunPod fait lui-même pour ses propres images à
# modèles inclus, qui vont jusqu'à 37,67 Go — chez GitHub, pas chez lui.
#
# La construction est donc dans `.github/workflows/construire.yml`, et l'image finie
# atterrit sur le registre de GitHub. Le point d'entrée l'importe de là.
#
